...
- [Introduction to Azure Bicep: Creating and Deploying Resources](https://www.linkedin.com/learning/introduction-to-azure-bicep-creating-and-deploying-resources/the-strength-of-azure-bicep)
...
- [Azure Bicep optional module names explained](https://johnlokerse.dev/2025/04/01/azure-bicep-optional-module-names-explained/)
...
- [Getting Started with Bicep's JSON-RPC Library: A Practical Guide](https://www.idontlikeai.dev/getting-started-with-biceps-json-rpc-library-a-practical-guide/)
...
- [Getting started with Deployment Stacks](https://msftplayground.com/2023/12/getting-started-with-deployment-stacks/)
...
- [How to easily developer your first Bicep Local Deploy extension with Bicep.LocalDeploy.Templates](https://www.idontlikeai.dev/how-to-easily-developer-your-first-bicep-local-deploy-extension-with-bicep-localdeploy-templates/)
- [Implement Scaling plans for Azure Virtual Desktop using Bicep](https://blog.poffers.cloud/posts/2025-01-avd-image-posts/implement-scalingplans-using-biciep-for-azure-virtual-desktop/)
...
- [Bicep Local Deploy doc generator](https://github.com/Gijsreyn/bicep-local-docgen)
- [Bicep Guide (advanced)](https://github.com/nnellans/bicep-guide/)
- [Bicep HTTP Extension](https://github.com/maikvandergaag/bicep-ext-http)
- [Bicep Local Samples](https://github.com/maikvandergaag/msft-bicep-local)
- [Bicep Samples](https://github.com/maikvandergaag/bicep)
- [brianveldman/bicep-ready-to-use-solutions](https://github.com/brianveldman/azure-bicep)
- [BuiltWithCaffeine - Bicep Snippets](https://github.com/builtwithcaffeine/bwc-bicep-repository)
